...
var UA = require('sip.js/lib/UA');
var Utils = require('sip.js/lib/Utils');
var Exceptions = require('sip.js/lib/Exceptions');
var Web = require('sip.js/lib/Web');
require('sip.js');
...
const SIPMethods = { Web: { Modifiers: Web.Modifiers }, Utils: Utils.Utils, Exceptions: Exceptions.Exceptions };
...
class WebRTCClient extends Emitter {
  ...
  createUserAgent()     {
    ...
    const userAgent = new UA.UA(webRTCConfiguration);
  ...
  hangup(session                                                         ) {
    try {
      ...
      const actions = {
        ...
        [Enums.SessionStatus.STATUS_1XX_RECEIVED]: isISC ? cancel : reject,
        // Status 4 (STATUS_WAITING_FOR_ANSWER) : cancel
        [Enums.SessionStatus.STATUS_WAITING_FOR_ANSWER]: isISC ? cancel : reject,
        // Status 8 (STATUS_CANCELED) : nothing to do
        [Enums.SessionStatus.STATUS_CANCELED]: null,
        // Status 9 (STATUS_TERMINATED): nothing to do
        [Enums.SessionStatus.STATUS_TERMINATED]: null,
        // Status 10 (STATUS_ANSWERED_WAITING_FOR_PRACK): bye
        [Enums.SessionStatus.STATUS_ANSWERED_WAITING_FOR_PRACK]: bye, // bye is the same for sdh ou isc
        // Status 12 (STATUS_CONFIRMED): bye
        [Enums.SessionStatus.STATUS_CONFIRMED]: bye, // bye is the same for sdh ou isc
      };

...
const setRefreshBackend = (refreshBackend        , forServer          = null) => {
...
var getApiClient = (forServer         )                => {
  const server         = forServer || global.wazoCurrentServer || '';
  if (server in global.wazoClients) {
    return fillClient(global.wazoClients[server]);
  }

  global.wazoClients[server] = new ApiClient({ server });
...
exports.setOnRefreshToken = setOnRefreshToken;
exports.setRefreshBackend = setRefreshBackend;
exports.setRefreshExpiration = setRefreshExpiration;
